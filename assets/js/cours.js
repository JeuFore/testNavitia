...
ajaxGet("https://api.navitia.io/", function (reponse) {
    var navitia = JSON.parse(reponse);
    // Récupération de certains résultat
    var descriptionElt = document.createElement("p");
    descriptionElt.textContent = premierMinistre.versions[0].status;
    var logoElt = document.createElement("img");
    logoElt.src = premierMinistre.logo;
    premMinElt.appendChild(descriptionElt);
    premMinElt.appendChild(logoElt);
