			...
			.then((destination) => {
				...
				request(url, function(err, response, body) {
					...
					var data = {
						...
						"url" : url,
						"depart" : {
							"hour" : result.journeys[0].departure_date_time.split("T")[1].slice(0,2),
							"minutes" : result.journeys[0].departure_date_time.split("T")[1].slice(2,4),
							"seconds" : result.journeys[0].departure_date_time.split("T")[1].slice(4,6)
						},
						"arrive" : {
							"hour" : result.journeys[0].arrival_date_time.split("T")[1].slice(0,2),
							"minutes" : result.journeys[0].arrival_date_time.split("T")[1].slice(2,4),
							"seconds" : result.journeys[0].arrival_date_time.split("T")[1].slice(4,6)
						},
