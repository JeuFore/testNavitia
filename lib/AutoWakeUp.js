	...
	return new Promise(function(resolve, reject) {
		...
		.then((origin) => {
			...
			.then((destination) => {
				...
				url = 'https://14ad8689-8f51-4489-942b-d5ff3746c793@api.navitia.io/v1/coverage/sncf/journeys?from=7.609352;48.4184995&to=7.7458461;48.5623326&first_section_mode[]=bike&min_nb_journeys=10&'
